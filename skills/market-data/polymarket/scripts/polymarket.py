...
Usage:
    ...
    python polymarket.py trending [--limit 10]
    python polymarket.py market <slug>
    python polymarket.py event <slug>
    python polymarket.py price <token_id>
    python polymarket.py book <token_id>
    python polymarket.py history <condition_id> [--interval all] [--fidelity 50]
    python polymarket.py trades [--limit 10] [--market CONDITION_ID]
"""
