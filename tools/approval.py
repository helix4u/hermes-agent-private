...
def _approval_key_aliases(pattern_key: str) -> set[str]:
    """Return approval keys that should match this pattern.

    New approvals use the human-readable description string, but older
    allowlist entries and session approvals may still contain the
...
def is_approved(session_key: str, pattern_key: str) -> bool:
    ...
    Accept both the canonical description-based key and the legacy
    regex-derived key so existing allowlist entries continue to work.
    """
